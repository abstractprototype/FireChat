...
//This adapter connects user_item.xml to UserFragment
public class ClassRoomAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {

    private Context context;
    private List<Classrooms> mClassrooms;
    private boolean isChat;

    //Constructor
    public ClassRoomAdapter(Context context, List<Classrooms> mClassrooms, boolean isChat){
    ...
    public ViewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_classrooms,
                parent,
                false);
